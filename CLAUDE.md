...
## Vad vi bygger
Fakturera som frilansare – utan eget företag, utan krångel, utan dyra avgifter.. Frilansfaktura låter dig skapa och skicka professionella fakturaunderlag på minuter – helt utan eget företag. Till skillnad från konkurrenterna tar vi ingen procentuell avgift som äter upp din vinst, utan en fast låg månadsavgift oavsett hur mycket du fakturerar. Perfekt för frilansskribenter, konsulter och kreatörer som vill hålla det enkelt och behålla mer av varje uppdrag.
...
<!-- nexar:opportunity slug=frilansfaktura -->
